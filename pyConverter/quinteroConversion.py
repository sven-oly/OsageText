...
# For parsing input
osage_latin_chars = u'ǫ́į́|ǫį́|ǫ́į|ą́ą́|ǫį|áį́|ǫį́|aá|ą́i|éį|áį|ą́a|į́i|eį́|' +\
                    'áa|àà|ąą|aį́|aí|ą́ą|ai|ái|aį|ąį|ą́i|âà|àâ|aa|br|ch|cɂ|ée|ee|' +\
  'ą́į|j̨j̨|óo|eį|h́|ą́ą́|į́į́|oį́|áá|éé|íi' +\
                    'hc|hk|hp|ht|íi|íi|įį|į́į|ii|ìì|' +\
                    'kɂ|óo|ǫǫ|ǫ́ǫ|oo|oį|óį|ǫ́i|oi|uu|úu|uú|úú|' +\
                    'ųų́|ų́ų́|ų́ų|ųų|' +\
                    'ą́|ą̄|ą|á|á|à|a|b|č|č|c|ç|ð|é|e|ɣ|h|į́|í|į|i|k|l|m|n|' +\
  'j́|ě|ś|ˀ|' +\
                    'ǫ́|ǫ|ó|o|p|s|š|t|u|ų́|ų|w|x|ž|z|ᶕ| |[\U00010400-\U000104f0]'
