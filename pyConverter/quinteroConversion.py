...
# For parsing input
osage_latin_chars = u'áa|àà|ąą|aį́|aí|ą́ą|ai|ái|aį|ąį|ą́i|âà|àâ|aa|br|ch|cɂ|ée|ee|' +\
                    'hc|hk|hp|ht|íi|íi|įį|į́į|ii|ìì|' +\
                    'kɂ|óo|ǫǫ|ǫ́ǫ|oo|oį|óį|ǫį́|ǫ́i|oi|uu|úu|uú|úú|' +\
                    'ųų́|ų́ų́|ų́ų|ųų|' +\
                    'ą́|ą̄|ą|á|á|à|a|b|č|c|ç|ð|é|e|ɣ|h|į́|í|į|i|k|l|m|n|' +\
